...
def get_prediction():
	...
	serum_level       = request.values.get('serum_level')
	blood_sugar       = request.values.get('blood_sugar')
	...
	model_prediction = predict(sex, age, race, height, weight, smoking, alcohol, general_health, sleep_time, mental_health, physical_health, physical_activity, bp, heart_rate, serum_level, blood_sugar, stroke, diabetic, asthma, skin_cancer, kidney_disease)
